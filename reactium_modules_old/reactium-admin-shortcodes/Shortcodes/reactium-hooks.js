...
Reactium.Plugin.register('shortcodes', Reactium.Enums.priority.lowest).then(
    () => {
        // RTE Plugin
        const RTEPlugin = Reactium.RTE.pluginFactory({
            type: 'shortcode',
            order: 100,
            callback: ShortcodeRTE,
        });

        Reactium.RTE.Plugin.register('shortcode', RTEPlugin);
