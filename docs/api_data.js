define({ "api": [
  ...
  },
  {
    ...
    "description": "<p>Reset a user password. The user will be sent an email after the password has been successfully changed. Returns <code>{Promise}</code>.</p> <p><em>Note: You must have an email driver setup for this to work.</em></p>",
    "parameter": {
      "fields": {
        "Parameter": [
          {
            ...
            "optional": false,
            "field": "token",
            "description": "<p>Token generated by <code>Actinium.User.resetRequest()</code>.</p>"
          },
          {
            "group": "Parameter",
            "type": "String",
    ...
    "examples": [
      {
        "title": "Example Usage:",
        "content": "Actinium.User.resetPassword('dGasDdoYlh0s55cu4rpglgm6LJhuuNVg', 'sekrit');",
        "type": "json"
      }
    ],
    "filename": "node_modules/@atomic-reactor/actinium-auth/actinium/plugin.js",
    "groupTitle": "Actinium"
  },
  {
    "type": "Function",
    ...
    "description": "<p>Request a password reset for a user. The user will be sent an email with a link to the password reset page. Returns a <code>{Promise}</code>.</p> <p><em>Note: You must have an email driver setup for this to work.</em></p>",
    "parameter": {
      "fields": {
        "Parameter": [
          {
            ...
            "optional": false,
            "field": "email",
            "description": "<p>The email address associated with the user.</p>"
          }
        ]
      }
    },
  ...
  },
  {
        ...
        "Parameter": [
          {
            ...
            "optional": false,
            "field": "token",
            "description": "<p>The token generated by password-reset-request.</p>"
          },
          {
            "group": "Parameter",
            "type": "String",
    ...
    "examples": [
      {
        "title": "Example Usage:",
        "content": "Actinium.Cloud.run('password-reset', { token: 'Ox3Nlojb', password: 'my.New-P455w0rd!' });",
        "type": "json"
      }
    ],
    "filename": "node_modules/@atomic-reactor/actinium-auth/actinium/plugin.js",
  ...
  },
  {
        ...
        "Parameter": [
          {
            ...
            "optional": false,
            "field": "email",
            "description": "<p>The email address associated with the user account you wish to reset.</p>"
          }
        ]
      }
    },
    "examples": [
      {
        "title": "Example Usage:",
        "content": "Actinium.Cloud.run('password-reset-request', { email: 'you@email.com' });",
        "type": "json"
      }
    ],
    "filename": "node_modules/@atomic-reactor/actinium-auth/actinium/plugin.js",
  ...
  },
  {
    ...
    "group": "Cloud",
    "name": "token-gen",
    "description": "<p>Generate a password reset token for the current user.</p>",
    "examples": [
      {
        "title": "Example Usage:",
        "content": "Actinium.Cloud.run('token-gen', {}, { sessionToken: 'VALID_SESSION_TOKEN' });",
        "type": "json"
      }
    ],
    "filename": "node_modules/@atomic-reactor/actinium-auth/actinium/plugin.js",
  ...
  },
  {
    ...
    "group": "Reactium.RTE",
    "name": "RTEPlugin",
    "description": "<p>RichTextEditor plugin instance used as the base when creating or extending RichTextEditor functionality.</p> <h2>Import</h2> <pre class=\"prettyprint\">import { RTEPlugin } from 'components/Admin/registered-components/RichTextEditor'; </code></pre> <blockquote> <p><strong>See:</strong> <a href=\"https://docs.slatejs.org/concepts/07-plugins\">Slate Plugins</a> for more information on how to augment the editor instance.</p> </blockquote>",
    "parameter": {
      "fields": {
        "Constructor": [
          {
        ...
        "Parameter": [
          {
            ...
            "optional": false,
            "field": "ID",
            "description": "<p>The unique ID used when registering the component's handle function.</p>"
          },
          {
            "group": "Parameter",
            "type": "String",
            "optional": false,
            "field": "className",
            "description": "<p>HTML class to apply to the wrapper container.</p>"
          },
          {
            "group": "Parameter",
            "type": "Boolean",
            ...
            "field": "collapsible",
            "defaultValue": "false",
            "description": "<p>Whether the dialog can be collapsed and expanded.</p>"
          },
          {
            "group": "Parameter",
            "type": "Boolean",
            ...
            "field": "confirm",
            "defaultValue": "false",
            "description": "<p>Whether selection requires a confirmation before the <code>onChange</code> event is triggered.</p>"
          },
          {
            "group": "Parameter",
            "type": "Boolean",
            ...
            "field": "dismissable",
            "defaultValue": "false",
            "description": "<p>Whether the dialog displays a close button to exit.</p>"
          },
          {
            "group": "Parameter",
            "type": "Mixed",
            "optional": true,
            "field": "filter",
            "description": "<p>Filter to apply to the media fetch used to display the Media Objects. Valid values: <code>Array</code>, <code>Function</code>, <code>String</code>.</p>"
          },
          {
            "group": "Parameter",
            "type": "Object",
            "optional": true,
            "field": "header",
            "description": "<p>Header configuration object. See [http://ui.reactium.io/toolkit/components/dialog-molecule](Reactium UI - Dialog) for more details.</p>"
          },
          {
            "group": "Parameter",
            "type": "Number",
            ...
            "field": "maxSelect",
            "defaultValue": "1",
            "description": "<p>Number greater than or equal to 1 representing the number of Media Objects that can be selected. When the value is less than 1, any number of items can be selected.</p>"
          },
          {
            "group": "Parameter",
            "type": "Number",
            ...
            "field": "minSelect",
            "defaultValue": "1",
            "description": "<p>Number greater than or equal to 1 representing the number of Media Objects that must be selected before the <code>onChange</code> event is triggered. When the value is less than 1, no mininum is required.</p>"
          },
          {
            "group": "Parameter",
            "type": "Function",
            "optional": true,
            "field": "onCancel",
            "description": "<p>Callback executed when the <code>onCancel</code> event is triggered.</p>"
          },
          {
            "group": "Parameter",
            "type": "Function",
            "optional": true,
            "field": "onChange",
            "description": "<p>Callback executed when the <code>onChange</code> event is triggered.</p>"
          },
          {
            "group": "Parameter",
            "type": "Function",
            "optional": true,
            "field": "onDismiss",
            "description": "<p>Callback executed when the <code>onDismiss</code> event is triggered.</p>"
          },
          {
            "group": "Parameter",
            "type": "Function",
            "optional": true,
            "field": "onError",
            "description": "<p>Callback executed when the <code>onError</code> event is triggered.</p>"
          },
          {
            "group": "Parameter",
            "type": "Function",
            "optional": true,
            "field": "onItemSelect",
            "description": "<p>Callback executed when the <code>onItemSelect</code> event is triggered.</p>"
          },
          {
            "group": "Parameter",
            "type": "Function",
            ...
            "description": "<p>Callback executed when the <code>onItemUnselect</code> event is triggered.</p>"
          },
          {
            "group": "Parameter",
            "type": "Function",
            "optional": true,
            "field": "onShow",
            "description": "<p>Callback executed when the <code>onShow</code> event is triggered.</p>"
          },
          {
            "group": "Parameter",
            "type": "String",
            "optional": true,
            "field": "pref",
            "description": "<p>Preferrance id used when the Dialog is collapsible. See [http://ui.reactium.io/toolkit/components/dialog-molecule](Reactium UI - Dialog) for more details.</p>"
          },
          {
            "group": "Parameter",
            "type": "String",
            "optional": true,
            "field": "search",
            "description": "<p>Filter Media Objects based on the search term entered.</p>"
          },
          {
            "group": "Parameter",
            "type": "Array",
            "optional": true,
            "field": "searchFields",
            "description": "<p>Array of fields to search relative to the Media Object.</p>"
          },
          {
            "group": "Parameter",
            "type": "Array",
            "optional": true,
            "field": "selection",
            "description": "<p>Array of Media Object IDs. Use this if you wish to have Media Objects selected by default.</p>"
          },
          {
            "group": "Parameter",
            "type": "Object",
            "optional": true,
            "field": "style",
            "description": "<p>Style object to apply to the wrapper container.</p>"
          },
          {
            "group": "Parameter",
            "type": "Mixed",
            "optional": true,
            "field": "title",
            "description": "<p><code>String</code> or <code>Node</code> that displays the Dialog title. This value is used if you do not specify a <code>header</code> object.</p>"
          },
          {
            "group": "Parameter",
            "optional": false,
            "field": "Event",
            "description": "<p>cancel Triggered when the selection is canceled. This event only fires if <code>confirm</code> is set to true.</p>"
          }
        ]
      }
    },
  ...
  },
  {
    ...
    "examples": [
      ...
      {
        "title": "Sub MenuItems:",
        "content": "import MenuItem from 'components/Admin/registered-components/MenuItem';\n\nconst SidebarWidget = () => (\n  <MenuItem\n    icon='Linear.Equalizer'\n    id='admin-sidebar-settings'\n    label='Settings'>\n    <MenuItem\n      label='App'\n      route='/admin/settings/app'\n      title='Application settings'\n    />\n    <MenuItem\n      label='Email'\n      route='/admin/settings/email'\n      title='Email settings'\n    />\n  </MenuItem>\n);",
        "type": "json"
      },
      {
