/*
    OBJECTIVES:
    1. Be able to pass value.
    2. Be able to have both controlled and uncontrolled inputs.
    3. Simple interface for updating internal state.
    4. Simple interface for event dispatchers.
*/
