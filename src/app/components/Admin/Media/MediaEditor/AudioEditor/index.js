...
/**
 * -----------------------------------------------------------------------------
 * Hook Component: AudioEditor
 * -----------------------------------------------------------------------------
 */
let AudioEditor = ({ children, ...props }, ref) => {
    // Refs
...
AudioEditor = forwardRef(AudioEditor);

AudioEditor.ENUMS = ENUMS;
...
AudioEditor.defaultProps = {
    namespace: 'ui-component',
};

export { AudioEditor as default };
